 ...
 * 
 */
@WebServiceClient(name = "AdderService", targetNamespace = "http://service.godoro.com/", wsdlLocation = "http://localhost:8080/EnterPrise01/AdderService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName ADDERSERVICE_QNAME = new QName("http://service.godoro.com/", "AdderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/EnterPrise01/AdderService?WSDL");
     ...
     * 
     * @return
     *     returns Hesap_0020Makinesi
     */
    @WebEndpoint(name = "Hesap MakinesiPort")
    public Hesap_0020Makinesi getHesap_0020MakinesiPort() {
        return super.getPort(new QName("http://service.godoro.com/", "Hesap MakinesiPort"), Hesap_0020Makinesi.class);
    }
     ...
     */
    @WebEndpoint(name = "Hesap MakinesiPort")
    public Hesap_0020Makinesi getHesap_0020MakinesiPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.godoro.com/", "Hesap MakinesiPort"), Hesap_0020Makinesi.class, features);
    }
